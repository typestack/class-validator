...
export class ValidationExecutor {
    ...
    private defaultValidations(object: Record<string, any>,
                               value: any,
                               metadatas: ValidationMetadata[],
                               errorMap: { [key: string]: string }): void {
        return metadatas
            .filter(metadata => {
                if (metadata.each) {
    ...
    private nestedValidations(value: any, metadatas: ValidationMetadata[], errors: ValidationError[],
                              definedMetadatas: ValidationMetadata[], allMetadatas: ValidationMetadata[]): void {
