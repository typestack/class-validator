...
validator.isPositive(value); // Checks if the value is a positive number greater than zero.
validator.isNegative(value); // Checks if the value is a negative number smaller than zero.
