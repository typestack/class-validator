...
| `@IsNullable()`                                        | Checks if given value is a null and if so, ignores all the validators on the property.                                                                                                |
| `@IsUndefined()`                                       | Checks if given value is a undefined and if so, ignores all the validators on the property.                                                                                           |
