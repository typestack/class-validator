...
| `@MinDate(date: Date)`                          | Checks if the value is a date that's not before the specified date.                                                                                                                                                                                                                                                                                                                                                  |
| `@MaxDate(date: Date)`                          | Checks if the value is a date that's not after the specified date.                                                                                                                                                                                                                                                                                                                                                   |
...
| `@ArrayMinSize(min: number)`                    | Checks if array's length is as minimal as this number.                                                                                                                                                                                                                                                                                                                                                               |
| `@ArrayMaxSize(max: number)`                    | Checks if array's length is as maximal as this number.                                                                                                                                                                                                                                                                                                                                                               |
